...
(
    id         bigint auto_increment comment '通过记录id' primary key,
...
create table follow
(
    id         bigint auto_increment comment '关注记录id' primary key,
...
(
    ...
    difficulty  tinyint                            null comment '题目难度（0-简单，1-中等，2-困难）',
    ...
    comments    bigint   default 0                 not null comment '评论数',
...
(
    id         bigint auto_increment comment '题解收藏记录id' primary key,
    solutionId bigint                             not null comment '题解id',
    userId     bigint                             not null comment '收藏人id',
    createTime datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    index          idx_userId (userId) comment '用户id索引',
...
(
    id          bigint auto_increment comment '竞赛报名记录id' primary key,
...
(
    id            bigint auto_increment comment '竞赛成绩记录id' primary key,
    contestId     bigint                             not null comment '竞赛id',
    applicantId   bigint                             not null comment '参赛者id',
